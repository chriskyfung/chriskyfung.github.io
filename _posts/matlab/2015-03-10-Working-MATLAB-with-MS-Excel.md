...
img="matlab/excel_addins_available" ext="png" alt="image: MS Excel Add-in Dialog" class="ml-5 mb-5" %}
...
img="matlab/excel_addin_menu" ext="png" alt="image: Menu of MATLAB Spreadsheet Link EX Add-In in Excel Toolbar" class="mb-5 text-center" %}
...
img="matlab/ml_cmd_window_taskbar.excel2010" ext="png" alt="image: Windows taskbar with MS Excel and MATLAB" class="mb-5 text-center" %}
...
img="matlab/excel_addin_menu_right_click" ext="png" alt="image: context menu of MATLAB Spreadsheet Link EX Add-In" class="mb-5" %}
